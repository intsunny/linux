...
# Regardless of the Fedora /usr merge, I'll keep setting up the PATH for now
...
synclient VertScrollDelta=315
synclient HorizScrollDelta=390
synclient VertEdgeScroll=0
synclient HorizEdgeScroll=0
synclient CornerCoasting=0
synclient VertTwoFingerScroll=1
synclient HorizTwoFingerScroll=0
synclient MinSpeed=1.50015
synclient MaxSpeed=2.39736
synclient AccelFactor=0.0296577
